package com.whl.wako.code.generator;
...
import static com.whl.wako.code.generator.GeneratorConstant.*;
...
class CodeGenerator {
    ...
    // 数据库地址，根据配置自行修改
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/wcs-asrs?useUnicode=true&characterEncoding=utf-8&serverTimezone=UTC";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "123321";
    private static final String JDBC_DIVER_CLASS_NAME = "com.mysql.jdbc.Driver";

    // 项目在硬盘上的基础路径
    private static final String PROJECT_PATH = "I:\\workspace\\wako\\wako-code-generate";
    ...
    // 生成的TkReposirtoy存放路径
    private static final String PACKAGE_PATH_REPOSITORY = packageConvertPath(MAPPER_PACKAGE);
    ...
    // @author
    private static final String AUTHOR = "paul.wei";
    // @date
    ...
    public static void main(String[] args) {
         genCode("wcs_asrs_task");
//        genCode("eagle_eye_work_order_task_queue","eagle_eye_work_order_user_slot");
//        genCode("eagle_eye_inspection_plan","eagle_eye_inspection_batch","eagle_eye_inspection_task","eagle_eye_sys_user");
//        genTest();
    }

//    @Test
//    public static void genTest(){
//        genTest(SampleServiceImpl.class,null);
//    }
    ...
    public static void genCodeByCustomModelName(String tableName, String modelName) {
        ...
        genTkRepository(tableName, modelName);
...
//        genController(tableName, modelName);
    ...
    public static void genTkRepository(String tableName, String modelName) {
        try {
...
//			data.put("modelNameLowerCamel", tableNameConvertLowerCamel(tableName));
            ...
            File file = new File(
                    PROJECT_PATH + JAVA_PATH + PACKAGE_PATH_REPOSITORY + modelNameUpperCamel + "TkRepository.java");
            if (!file.getParentFile().exists()) {
                file.getParentFile().mkdirs();
            }
            cfg.getTemplate("repository.ftl").process(data, new FileWriter(file));
            System.out.println(modelNameUpperCamel + "TkRepository.java 生成成功");
        } catch (Exception e) {
            throw new RuntimeException("生成TkRepository失败", e);
        }
    }
...
//			data.put("modelNameLowerCamel", tableNameConvertLowerCamel(tableName));
            ...
            File file = new File(
                    PROJECT_PATH + JAVA_PATH + PACKAGE_PATH_SERVICE + modelNameUpperCamel + "BizService.java");
            if (!file.getParentFile().exists()) {
                file.getParentFile().mkdirs();
            }
            ...
            File file1 = new File(
                    PROJECT_PATH + JAVA_PATH + PACKAGE_PATH_SERVICE_IMPL + modelNameUpperCamel + "BizServiceImpl.java");
